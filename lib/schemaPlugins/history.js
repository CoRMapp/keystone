...
const getHistoryModelName = (list) => {
	return list.options.schema.collection + historyModelSuffix;
};

const getHistoryModel = (list, userModel) => {
...
module.exports = function history () {
	...
	list.schema.pre('deleteOne', { document: true, query: false }, function (next) {
		const data = this.toObject();
		data.__v = undefined;
