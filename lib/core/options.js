		...
		case 'cloudinary config':
			...
			if (typeof value === 'string') {
				...
				value = {
					...
					private_cdn: parts.pathname !== '/' && parts.pathname !== '',
					secure_distribution: parts.pathname && parts.pathname.slice(1),
				};
			}
...
exports.expandPath = function (pathValue) {
	pathValue = (typeof pathValue === 'string' && pathValue.slice(0, 1) !== path.sep && pathValue.slice(1, 2) !== ':\\')
